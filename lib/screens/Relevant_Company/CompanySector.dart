...
import 'package:stugetow/models/Relevant_Companies/Companies.dart';
...
class CompanySector extends StatefulWidget {
  final Function notifyParent;

  CompanySector({Key? key, required this.notifyParent}) : super(key: key);

  @override
  CompanySectorState createState() => CompanySectorState();
}

class CompanySectorState extends State<CompanySector> {
  bool isKeyboardVisible = false;
  List<bool> _likes = List.filled(relevantPosts.length, false);

  List<String> _pdfNames = [];
  List<File> _pdfdocfiles = [];
  List<PDFDocument> _pdfdocumentList = [];

  EdgeInsets _viewInsetsRel = EdgeInsets.fromWindowPadding(WidgetsBinding.instance!.window.viewInsets,WidgetsBinding.instance!.window.devicePixelRatio);
  @override
                                  ...
                                  Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'date close: ${relevantPosts[index].date}',
                                          style: TextStyle(
                                  ...
                                  GestureDetector(
                                    onTap: () => Navigator.push(
                                      ...
                                      AnimatedPageRoute(
                                        page: CompanyPostDestinationScreen(
                                            destination: relevantPosts[index],
                                            liked: _likes[index],
                                            index: index,
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Container(
                                            child: relevantPosts[index].imgPostUrl == "" ? null
                                                : Image.asset(relevantPosts[index].imgPostUrl,
                                            ),
                                          ),
                                        ],
                                      ),
                ...
                Stack(
                  children: <Widget>[
                    AnimatedContainer(
                      ...
                      padding: EdgeInsets.only(top: 50.0, bottom:  63.0+(isKeyboardVisible?_viewInsetsRel.bottom:0)),
                      decoration: BoxDecoration(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Text(
                                                'posted on: ${relevantPosts[index].date}',
                                                style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      0, 0, 0, .4),
                                                  fontSize: 10,
                        ...
                        child: Row(
                          ...
                          children: [
                            AnimatedContainer(
                              ...
                              padding: EdgeInsets.only(bottom: isKeyboardVisible?_viewInsetsRel.bottom:0),
            ...
            child: Padding(
              ...
              child: ListView(
                children: <Widget>[
                  TextButton(
                    onPressed: () {
                      String path = relevantPosts[index].imgPostUrl.substring(7);
  ...
  Future _shareFile(int index) async {
    String originPath = relevantPosts[index].imgPostUrl;
    File convertedImage;
  ...
  Future _saveImageToDevice(String originPath) async {
    ...
    File convertedImage = await getImageFileFromAssets(imgPath);
    String name = basename(convertedImage.path);
    final File newImg = await convertedImage.copy('$dirPath/stugetow_$name');
  }
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage(relevantPosts[index].sender.imageUrl),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
  ...
  void initState() {
    super.initState();
    _viewInsetsRel = EdgeInsets.fromWindowPadding(WidgetsBinding.instance!.window.viewInsets,WidgetsBinding.instance!.window.devicePixelRatio);

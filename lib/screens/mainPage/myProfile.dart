...
import 'package:stugetow/models/mainPage/editMyProfile.dart';
...
class MyProfileDestinationScreen extends StatefulWidget {
  final User? destination;
  MyProfileDestinationScreen({this.destination});

  @override
  _MyProfileDestinationScreenState createState() => _MyProfileDestinationScreenState();
}

class _MyProfileDestinationScreenState extends State<MyProfileDestinationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        Icon(Icons.arrow_back, color: Color.fromRGBO(9, 86, 164, 1)),
          iconSize: 25.0,
          ...
          IconButton(
            onPressed: (){
              Navigator.push(context,
                AnimatedPageRouteSlide(page: SharePost()),
              );
            },
            icon: Icon(Icons.add, color: Color.fromRGBO(9, 86, 164, 1),size: 32,),
          ),
        ],
      ),
              ...
              children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.fill,
                              image:  (_imageUrl==null? AssetImage('assets/images/logo/stugetow_user.png'):NetworkImage(_imageUrl!)) as ImageProvider<Object>,
                            ),
                          ),
                        ),
                      ),
                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    onPressed: ()=>{
                      Navigator.push(context,
                      AnimatedPageRouteSlide(page: EditProfile(destination: widget.destination)),
                      ),
                    },
                    child: Icon(Icons.edit,size: 30,color:Color.fromRGBO(10, 90, 150, .8)),
                  ),
                ),
                Divider(indent: 15,endIndent: 15,color:Colors.blueGrey[300], thickness: 3,),
                Container(
              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(context,
                        AnimatedPageRoute(page:
                        StudentPostDestinationScreen(
                          destination: postByUser[index], liked: _likes[index],
                          index: index, notifyParent: refresh,
                        ),
                        ),
                      ),
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              null :Image.asset(postByUser[index].imgPostUrl),
                            ),
                          ],
                        ),
                      ),
                            ...
                            children: [
                              IconButton(
                                icon: ShaderMask(
                                  ...
                                  child: Icon(_likes[index]? Icons.favorite:Icons.favorite_border),
                ...
                Stack(
                  children: <Widget>[
                    AnimatedContainer(
                      ...
                      height: _isKeyboardVisible? 437//MediaQuery.of(context).size.height*.51

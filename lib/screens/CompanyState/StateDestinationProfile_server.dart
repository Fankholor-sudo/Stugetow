...
class StateDestinationProfileScreen extends StatefulWidget {
  final dynamic destination;

  StateDestinationProfileScreen({this.destination});

  @override
  _StateDestinationProfileScreenState createState() => _StateDestinationProfileScreenState();
}

class _StateDestinationProfileScreenState extends State<StateDestinationProfileScreen> {
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => Navigator.push(context,
                          AnimatedPageRoute(
                            page: ViewPhotoCompanyServer(destination: widget.destination.sender),
                          ),
                        ),
                        child: Container(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                iconSize: 22.0,
                                onPressed: () async {
                                  // final ByteData bytes = await rootBundle.load(allJobPosts[index].imgPostUrl);
                                  // Share.files(

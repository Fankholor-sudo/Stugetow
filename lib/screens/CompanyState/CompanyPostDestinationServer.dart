...
class CompanyPostDestinationServer extends StatefulWidget {
  final dynamic destination;
  final bool? liked;
  final int? index;
  final Function notifyParent;
  CompanyPostDestinationServer({Key? key,this.destination, this.liked, this.index,required this.notifyParent}):super(key: key);
  @override
  _CompanyPostDestinationServerState createState() => _CompanyPostDestinationServerState();
}

class _CompanyPostDestinationServerState extends State<CompanyPostDestinationServer> {
            ...
            Center(
              child: InteractiveViewer(
                ...
                child: Container(
                  ...
                  child: Image.network(widget.destination.imgUrl!),
                ),
              ),
            ),
            Positioned(

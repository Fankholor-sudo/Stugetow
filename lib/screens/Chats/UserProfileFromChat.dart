...
class UserProfileFromChatDestination extends StatefulWidget {
  final User? destination;

  UserProfileFromChatDestination({this.destination});

  @override
  _UserProfileFromChatDestinationState createState() =>
      _UserProfileFromChatDestinationState();
}

class _UserProfileFromChatDestinationState
    extends State<UserProfileFromChatDestination> {
          ...
          SliverAppBar(
            ...
            actions: <Widget>[
              PopupMenuButton<String>(
                onSelected: null,
                icon: Icon(Icons.more_horiz, color: Colors.grey[50]),
                          ...
                          for (var count = 0; count < 11; ++count)
                            GridTile(
                              child: Card(
                                child: Container(
                                  child: Image.asset(
                                    favoriteInstitution[count].imageUrl,
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ),

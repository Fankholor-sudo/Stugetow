...
class SchoolCommentDestination extends StatefulWidget {
  final MessageChats? destination;
  SchoolCommentDestination({this.destination});

  @override
  _SchoolCommentDestinationState createState() => _SchoolCommentDestinationState();
}

class _SchoolCommentDestinationState extends State<SchoolCommentDestination> {
  @override

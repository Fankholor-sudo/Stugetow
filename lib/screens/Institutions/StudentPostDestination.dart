...
class StudentPostDestinationScreen extends StatefulWidget {
  final MessageChats? destination;
  final bool? liked;
  final int? index;
  final Function? notifyParent;
  StudentPostDestinationScreen({this.destination, this.liked, this.index, this.notifyParent});

  @override
  _StudentPostDestinationScreenState createState() => _StudentPostDestinationScreenState();
}

class _StudentPostDestinationScreenState extends State<StudentPostDestinationScreen> {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          iconSize: 22.0,
                          onPressed: () async {
                            final ByteData bytes = await rootBundle.load(postByUser[widget.index!].imgPostUrl);
                            // Share.files(
                            ...
                            //     },
                            //     "*/*",
                            //     text: postByUser[widget.index].text
                            // );
                          },
                        ),
                      ],
                ...
                Stack(
                  children: <Widget>[
                    AnimatedContainer(
                      ...
                      height: isKeyboardVisible? 437//MediaQuery.of(context).size.height*.51
